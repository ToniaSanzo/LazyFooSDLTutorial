...
//void LTexture::updateScale(int sc) { scale = sc; }
//
...
//
//                // Render arrow to the center of the screen
//                gArrowTexture.render((SCREEN_WIDTH - (gArrowTexture.getWidth() * gArrowTexture.getScale())) / 2, (SCREEN_HEIGHT - (gArrowTexture.getHeight() * gArrowTexture.getScale())) / 2, NULL, degrees, NULL, flipType);
//
//                // Update screen
