...
//
//        // Load pause texture
//        if (!gPauseTextTexture.loadFromRenderedText("Press \"P\" to pause/unpause the timer.", textColor)) {
//            printf("Unable to render pause texture!\n");
//            success = false;
//        }
//
//        // Load start texture
//        if (!gStartTextTexture.loadFromRenderedText("Press \"S\" to start/stop the timer.", textColor)) {
...
//
//                // Render the textures
//                gStartTextTexture.render((SCREEN_WIDTH - gStartTextTexture.getWidth()) / 2, 0);
//                gPauseTextTexture.render((SCREEN_WIDTH - gStartTextTexture.getWidth()) / 2, gStartTextTexture.getHeight());
//                
