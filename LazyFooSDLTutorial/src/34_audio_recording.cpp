...
//	{
//		//Render the prompt
//		if (!gPromptTexture.loadFromRenderedText("Select your recording device:", gTextColor))
//		{
//			printf("Failed to render prompt text!\n");
//			success = false;
//		}
//
//		// Get number of audio recording devices (SDL_TRUE)
//		// *NOTE - SDL_FALSE results in the number of audio 
//		//		   playback devices.
...
//											int bytesPerSample = gReceivedRecordingSpec.channels * (SDL_AUDIO_BITSIZE(gReceivedPlaybackSpec.format) / 8);
//
...
//					for (int i = 0; i < gRecordingDeviceCount; ++i) {
//						gDeviceTextures[i].render((SCREEN_WIDTH - gDeviceTextures[i].getWidth()) / 2, 30 + (i * gDeviceTextures[i].getHeight()));
//					}
//				}
//
//				//Update screen
